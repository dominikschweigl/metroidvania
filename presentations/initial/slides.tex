...
\begin{frame}
	...
	\begin{itemize}
		\item \file{assets/} - Images, audio, fonts
		\item \file{build/} - build
		\item \file{data/} - Maps, entities, animations
		\item \file{docs/} - documentations
		\item \file{saves/} - Game state savepoints
		\item \file{src/} - Game and engine code
		      \begin{itemize}
			      \item \file{core/} - Main Game loop, Window Manager
			      \item \file{entities/} - Entity logic
			      \item \file{rendering/} - Rendering
			      \item \file{utils/} - Other helpers/Managers
			      \item \file{world/} - World building
		      \end{itemize}
		\item \file{tests/} - Unit and integration tests
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Player movement \& combat - Dominik
		\item Enemies \& menus - Lukas
		\item Maps \& saving - Emanuel
	\end{itemize}
