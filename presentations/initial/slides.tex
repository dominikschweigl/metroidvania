...
\subsection{State Loading/Unloading}

\begin{frame}
	\frametitle{State Loading/Unloading}

	\textbf{Main dynamic JSON-File}

	\begin{itemize}
		\item player-data (currency, xp, ...)
		\item room-data (collectables and enenmy booleans)
	\end{itemize}

	\textbf{Loading}

	\begin{itemize}
		\item loading static room json
		\item overwriting with state json
	\end{itemize}

	\textbf{Unloading}

	\begin{itemize}
		\item Fixed savepoints for resetting room-data
	\end{itemize}
