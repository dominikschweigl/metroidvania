...
EnemyState *ChargeAttackState::update(float deltaTime, BaseEnemy &enemy, const World & /*world*/,
...
void ChargeAttackState::onEnter(BaseEnemy &enemy)
{
	...
	AudioManager::getInstance().playSound(SoundEffect::TRANSISTOR_BOSS_CHARGE_ATTACK);
}
